...
class Admin1 : public CDialog
{
public:
	Admin1(CWnd* pParent = NULL);   // standard constructor

	enum { IDD = IDD_DIALOG_ADMIN1 };
...
protected:
	...
	CEdit m_EditBox_OutputFileName;
	CButton m_static_ButtonPrimary, m_static_ButtonSecondary;
	CButton m_Group_SpreadsheetSelect;
...
public:
	...
	afx_msg void OnBnClickedSecondary();
	BOOL checkOutputDirectory(char *ptrFilename);	
};