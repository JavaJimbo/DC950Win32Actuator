// NumSpinCtrl - these routines are for setting up and using the "spin" controls
// on the Admin dialog box. Spin controls are the up and down arrows
// attached to the right side of each Edit box.
// The increment or decrement the values displayed in the Edit box
// when the user clicks on them.
// This was taken from the Internet and no modifications have been made.
//
